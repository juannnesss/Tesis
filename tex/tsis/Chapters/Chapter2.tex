...
For the rest of this monography we will be focused in the type-II and non-collinear configuration. Using first order perturbation theory  and the paraxial approximation, the two-photon state
...
is pearson coeficient realted to correlations parameter ???
\begin{comment}
...
\begin{figure}[h!]
\centering
{  \includegraphics[width=0.48\textwidth]{Figures/correlationsWaist.png} }
{  \includegraphics[width=0.48\textwidth]{Figures/correlationsWaist2.png} }
...
correspondence is determined by the ratio $D/ $


by some parameters, if we want to have a almost-perfect correspondence we 
