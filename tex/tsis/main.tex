...
\thesistitle{Ghost Imaging Using Spatial Correlations} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\vfill
\includegraphics[width=0.1\textwidth]{Logo.png} % University/department logo - uncomment to place it
...
s \cite{spatiocorrelations} ss \cite{omar} green \cite{green} green here \cite{green} Shih\cite{introquantumoptics}
